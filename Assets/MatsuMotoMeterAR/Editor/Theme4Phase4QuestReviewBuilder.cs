...
{
    internal static class Theme4Phase4QuestReviewBuilder
    {
        internal const string OutputPath =
            "Builds/QuestReview/AnalogInstrumentMR-Theme4-P4-review-quest3.apk";

        private const string CandidateId = "Theme4_P4_Delivery";
        ...
        private const string QuarantinedDevAgentSettingsPath =
            ...
            "DevAgentSettings.theme4-p4-review.local.asset";
        ...
        private const string CandidateResourcePrefix =
            "Theme4_P4_Delivery/MachinedErgonomics/Prefabs/";
        ...
        [MenuItem(
            ...
            "Build Phase 4 Quest Review APK")]
        public static void Build()
        {
            ...
            Theme4Phase4CandidateBuilder.PrepareQuestReviewResources();
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Theme 4 P4 review build failed: " +
                        $"{report.summary.result}; " +
                        $"{report.summary.totalErrors} error(s).");
                }

                Debug.Log(
                    $"Theme 4 P4 Quest review APK built: {OutputPath}; " +
