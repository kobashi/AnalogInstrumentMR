...
{
    internal static class Theme4Phase2CandidateBuilder
    {
        ...
        private const string CandidateRoot =
            ...
            "CandidateStaging/Theme4_P2_Delivery";
        ...
        private const string QuestResourceRoot =
            CandidateRoot + "/Resources/Theme4_P2_Delivery/" +
            "MachinedErgonomics/Prefabs";
        private const string ReportPath =
            "Builds/Reports/candidate-Theme4_P2-delivery-validation.md";
        private const string VisualReviewRoot =
            "Builds/Reports/Theme4_P2_VisualReview";
        ...
        private const string OpaqueMaterialPath =
            MaterialRoot + "/MAT_MachinedErgonomics_P2_Atlas_Staging.mat";
        private const string EmissiveMaterialPath =
            MaterialRoot + "/MAT_MachinedErgonomics_P2_Emissive_Staging.mat";

        private static readonly AssetSpec[] Assets =
        {
            new(
                "MeterRound",
                "SM_MeterRound_MachinedErgonomics_V6_Opus5_P2.fbx",
                "needle_pivot",
                "needle",
                Vector3.forward,
                ...
                new Vector3(0.136f, 0.136174f, 0.064f),
                0.0525f,
                "4e4d36e5d39f819b71b866f755dde814330f23276e2df6caaa12603bb15a79be"),
            new(
                "Lever",
                "SM_Lever_MachinedErgonomics_V6_Opus5_P2.fbx",
                "handle_pivot",
                "handle",
                Vector3.right,
                ...
                0.011402f,
                "94691ad49b3370bae222342cbd6e113121e67094d636e33abd91730414bd41ec"),
            new(
                "Toggle",
                "SM_Toggle_MachinedErgonomics_V6_Opus5_P2.fbx",
                "switch_pivot",
                "switch",
                Vector3.right,
                ...
                0.0338f,
                "c5f9396e7055d3cfcf63dac005b5850716072e4595d45e6fe027b587a1ed118a")
        };

        [MenuItem(
            "Tools/MatsuMotoMeterAR/Theme 4/" +
            "Build and Validate Phase 2 Candidate")]
        ...
        internal static void PrepareQuestReviewResources()
        {
            ...
            foreach (var spec in Assets)
            {
                var source =
                    ...
                    "MachinedErgonomics_P2_Staging.prefab";
                var destination =
        ...
        {
            if (!File.Exists(path))
                throw new FileNotFoundException("Theme 4 P2 input is missing.", path);
            var actual = Sha256(path);
            if (!string.Equals(actual, expected, StringComparison.Ordinal))
            {
                throw new InvalidDataException(
                    $"Theme 4 P2 SHA mismatch for {path}: {actual}");
            }
        }
            ...
            Material emissive)
        {
            ...
            if (source == null)
                throw new FileNotFoundException("Imported P2 FBX is missing.", modelPath);
            ...
            var prefabName = $"PF_Visual_{spec.Key}_MachinedErgonomics_P2_Staging";
        ...
        private static void Validate(Material opaque, Material emissive)
        {
            ...
            report.AppendLine("# Theme 4 Phase 2 isolated candidate validation");
            report.AppendLine();
            report.AppendLine(
            ...
            if (failures.Count > 0)
                throw new InvalidOperationException("Theme 4 P2 candidate validation failed.");
            Debug.Log("Theme 4 P2 isolated candidate PASS: " + ReportPath);
        }
        ...
        {
            var prefabPath =
                $"{PrefabRoot}/PF_Visual_{spec.Key}_MachinedErgonomics_P2_Staging.prefab";
        ...
        private static void RenderVisualReview()
        {
            ...
            WritePng(
                $"{VisualReviewRoot}/ContactSheet_Theme4_P2_Unity_colour.png",
                colourSheet,
                cellSize * 4,
                cellSize * 3);
            WritePng(
                $"{VisualReviewRoot}/ContactSheet_Theme4_P2_Unity_grayscale.png",
                grayscaleSheet,
                cellSize * 4,
                cellSize * 3);
            File.AppendAllText(
                ...
                "- 12 fixed-camera renders: `Builds/Reports/Theme4_P2_VisualReview/Unity_*.png`\n" +
                "- Colour contact sheet: `ContactSheet_Theme4_P2_Unity_colour.png`\n" +
                "- Grayscale contact sheet: `ContactSheet_Theme4_P2_Unity_grayscale.png`\n" +
            ...
            Debug.Log("Theme 4 P2 Unity visual review written to " + VisualReviewRoot);
        }
        ...
        private static RoleLuminance ValidateAtlasRoleLuminance()
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidDataException("Could not decode Theme 4 P2 atlas PNGs.");
                }
                ...
                if (!(gasket < metal && metal < body && body < readout))
                    throw new InvalidDataException("Theme 4 P2 BaseColor role luminance order failed.");
                if (emissionBody > 0.01f || emissionMetal > 0.01f ||
                    emissionGasket > 0.01f || emissionReadout < 0.5f)
                {
                    throw new InvalidDataException("Theme 4 P2 emission quadrant contract failed.");
                }
            ...
            int size)
        {
            ...
            var root = new GameObject("Theme4 P2 Visual Review Root");
            var instance = UnityEngine.Object.Instantiate(prefab, root.transform, false);
            var cameraObject = new GameObject("Theme4 P2 Review Camera");
            var lightObject = new GameObject("Theme4 P2 Review Key Light");
            var fillObject = new GameObject("Theme4 P2 Review Fill Light");
