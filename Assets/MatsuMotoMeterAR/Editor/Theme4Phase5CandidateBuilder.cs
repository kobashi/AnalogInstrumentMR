...
{
    internal static class Theme4Phase5CandidateBuilder
    {
        ...
        private const string CandidateRoot =
            ...
            "CandidateStaging/Theme4_P5_Delivery";
        ...
        private const string QuestResourceRoot =
            CandidateRoot + "/Resources/Theme4_P5_Delivery/" +
            "MachinedErgonomics/Prefabs";
        private const string ReportPath =
            "Builds/Reports/candidate-Theme4_P5-delivery-validation.md";
        private const string VisualReviewRoot =
            "Builds/Reports/Theme4_P5_VisualReview";
        ...
        private const string OpaqueMaterialPath =
            MaterialRoot + "/MAT_MachinedErgonomics_P5_Atlas_Staging.mat";
        private const string EmissiveMaterialPath =
            MaterialRoot + "/MAT_MachinedErgonomics_P5_Emissive_Staging.mat";
        ...
        private static readonly AssetSpec[] Assets =
        {
            ...
            new(
                "Lever",
                "SM_Lever_MachinedErgonomics_V6_Opus5_P5.fbx",
                "handle_pivot",
                "handle",
                Vector3.right,
                ...
                0.0148f,
                "e19e3b30264ea35c50d617da585e126efcee10ab3c0dda7454d68107f98cffe8"),
            new(
                "Toggle",
                "SM_Toggle_MachinedErgonomics_V6_Opus5_P5.fbx",
                "switch_pivot",
                "switch",
                Vector3.right,
                ...
                0.032f,
                "505bf6cdfa756c9664926add937febcd8bab72690395defb80765f08d0c480c1")
        };

        [MenuItem(
            "Tools/MatsuMotoMeterAR/Theme 4/" +
            "Build and Validate Phase 5 Candidate")]
        ...
        internal static void PrepareQuestReviewResources()
        {
            ...
            foreach (var spec in Assets)
            {
                var source =
                    ...
                    "MachinedErgonomics_P5_Staging.prefab";
                var destination =
        ...
        {
            if (!File.Exists(path))
                throw new FileNotFoundException("Theme 4 P5 input is missing.", path);
            var actual = Sha256(path);
            if (!string.Equals(actual, expected, StringComparison.Ordinal))
            {
                throw new InvalidDataException(
                    $"Theme 4 P5 SHA mismatch for {path}: {actual}");
            }
        }
            ...
            Material emissive)
        {
            ...
            if (source == null)
                throw new FileNotFoundException("Imported P5 FBX is missing.", modelPath);
            ...
            var prefabName = $"PF_Visual_{spec.Key}_MachinedErgonomics_P5_Staging";
        ...
        private static void Validate(Material opaque, Material emissive)
        {
            ...
            report.AppendLine("# Theme 4 Phase 5 isolated candidate validation");
            report.AppendLine();
            report.AppendLine(
            ...
            if (failures.Count > 0)
                throw new InvalidOperationException("Theme 4 P5 candidate validation failed.");
            Debug.Log("Theme 4 P5 isolated candidate PASS: " + ReportPath);
        }
        ...
        {
            var prefabPath =
                $"{PrefabRoot}/PF_Visual_{spec.Key}_MachinedErgonomics_P5_Staging.prefab";
        ...
        private static void RenderVisualReview()
        {
            ...
            WritePng(
                $"{VisualReviewRoot}/ContactSheet_Theme4_P5_Unity_colour.png",
                colourSheet,
                cellSize * 4,
                cellSize * 3);
            WritePng(
                $"{VisualReviewRoot}/ContactSheet_Theme4_P5_Unity_grayscale.png",
                grayscaleSheet,
                cellSize * 4,
                cellSize * 3);

            var meterPath =
                $"{PrefabRoot}/PF_Visual_MeterRound_MachinedErgonomics_P5_Staging.prefab";
            ...
            File.AppendAllText(
                ...
                "- 12 fixed-camera renders: `Builds/Reports/Theme4_P5_VisualReview/Unity_*.png`\n" +
                "- Colour contact sheet: `ContactSheet_Theme4_P5_Unity_colour.png`\n" +
                "- Grayscale contact sheet: `ContactSheet_Theme4_P5_Unity_grayscale.png`\n" +
            ...
            Debug.Log("Theme 4 P5 Unity visual review written to " + VisualReviewRoot);
        }
        ...
        private static RoleLuminance ValidateAtlasRoleLuminance()
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidDataException("Could not decode Theme 4 P5 atlas PNGs.");
                }
                ...
                if (!(gasket < metal && metal < body && body < readout))
                    throw new InvalidDataException("Theme 4 P5 BaseColor role luminance order failed.");
                if (emissionBody > 0.01f || emissionMetal > 0.01f ||
                    emissionGasket > 0.01f || emissionReadout < 0.5f)
                {
                    throw new InvalidDataException("Theme 4 P5 emission quadrant contract failed.");
                }
            ...
            Vector3 isolatedAxis = default)
        {
            ...
            var root = new GameObject("Theme4 P5 Visual Review Root");
            var instance = UnityEngine.Object.Instantiate(prefab, root.transform, false);
            var cameraObject = new GameObject("Theme4 P5 Review Camera");
            var lightObject = new GameObject("Theme4 P5 Review Key Light");
            var fillObject = new GameObject("Theme4 P5 Review Fill Light");
