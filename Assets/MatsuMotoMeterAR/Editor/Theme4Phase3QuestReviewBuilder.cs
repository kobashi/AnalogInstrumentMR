...
{
    internal static class Theme4Phase3QuestReviewBuilder
    {
        internal const string OutputPath =
            "Builds/QuestReview/AnalogInstrumentMR-Theme4-P3-review-quest3.apk";

        private const string CandidateId = "Theme4_P3_Delivery";
        ...
        private const string QuarantinedDevAgentSettingsPath =
            ...
            "DevAgentSettings.theme4-p3-review.local.asset";
        ...
        private const string CandidateResourcePrefix =
            "Theme4_P3_Delivery/MachinedErgonomics/Prefabs/";
        ...
        [MenuItem(
            ...
            "Build Phase 3 Quest Review APK")]
        public static void Build()
        {
            ...
            Theme4Phase3CandidateBuilder.PrepareQuestReviewResources();
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Theme 4 P3 review build failed: " +
                        $"{report.summary.result}; " +
                        $"{report.summary.totalErrors} error(s).");
                }

                Debug.Log(
                    $"Theme 4 P3 Quest review APK built: {OutputPath}; " +
