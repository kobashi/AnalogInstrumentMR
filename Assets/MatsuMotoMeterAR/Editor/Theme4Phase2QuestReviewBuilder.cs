...
{
    internal static class Theme4Phase2QuestReviewBuilder
    {
        internal const string OutputPath =
            "Builds/QuestReview/AnalogInstrumentMR-Theme4-P2-review-quest3.apk";

        private const string CandidateId = "Theme4_P2_Delivery";
        ...
        private const string QuarantinedDevAgentSettingsPath =
            ...
            "DevAgentSettings.theme4-p2-review.local.asset";
        ...
        private const string CandidateResourcePrefix =
            "Theme4_P2_Delivery/MachinedErgonomics/Prefabs/";
        ...
        [MenuItem(
            ...
            "Build Phase 2 Quest Review APK")]
        public static void Build()
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException(
                        $"Theme 4 P2 review build failed: " +
                        $"{report.summary.result}; " +
                        $"{report.summary.totalErrors} error(s).");
                }

                Debug.Log(
                    $"Theme 4 P2 Quest review APK built: {OutputPath}; " +
