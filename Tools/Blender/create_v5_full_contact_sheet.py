"""Create the complete 11-object x 3-theme V5 grayscale review sheet."""
...
OUTPUT = ROOT / "docs/images/AnalogInstrumentMR_V5_11Objects_3Themes_Grayscale.png"
...
def main():
    ...
    draw.text(
        (48, 34),
        "AnalogInstrumentMR V5 — 11 Objects × 3 Theme Families",
        font=title,
        fill=(237, 243, 248),
    )
    draw.text(
        (50, 105),
        "Grayscale shape review: theme identity must remain readable without color.",
        font=subtitle,
        fill=(147, 165, 179),
    )
    draw.text(
        (50, 143),
        "Shared constraints: mounting envelope and interaction pivot. "
        "Visible silhouettes are independently authored per theme.",
        font=subtitle,
        fill=(147, 165, 179),
    )
